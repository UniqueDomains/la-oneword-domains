...
**Public extract:** 7,893 rows · **Live catalog:** 7,888 domains
...
- `la.csv` — public CSV extract (7,893 rows)
- `la.json` — public JSON extract (7,893 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,893-row public sample | 7,888 live domains                               |
